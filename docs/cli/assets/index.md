...
- [import](#command-assets-import) — Import a specific asset
- [refresh](#command-assets-refresh) — Refresh all assets (like focusing the editor)
...
| --- | --- | --- | --- | --- | --- |
| PATH | Yes | 1 | — | — | Asset path (e.g., Assets/Textures/logo.png) |
...
<a id="command-assets-refresh"></a>
## `assets refresh`

Refresh all assets (like focusing the editor)
